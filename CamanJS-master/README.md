...
This version has been altered for use in a course project at Aalto University. This is not meant for general use or distribution. The code is just meant to be used to test the potential of HTML5 web workers in an online image editor.

The code is used in accordance with the CamanJS license, which can be found in the LICENSE file in this directory.
